...
LocaleTable.availableLocaleCodes = ["en"];
...
chrome.i18n.getMessage = function(message, params) {
  if(params) {
    ...
    if (!LocaleTable.instance.getCache(message)) {
      LocaleTable.instance.setCache(message, chrome.i18n.safeGetMessage(message));
    }
    return LocaleTable.instance.getCache(message);
  }
