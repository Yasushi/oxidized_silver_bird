var Composer = {
  ...
  textareaChanged: function (e) {
    ...
    var availableChars = MAX_TWEET_SIZE - twttr.txt.getTweetLength(el.val());
    ...
    if(availableChars < 0 || availableChars == MAX_TWEET_SIZE) {
      ...
      $("#compose_tweet_area input[type='button']").prop("disabled", true);
    } else {
      charsLeftEl.css('color', 'black');
      $("#compose_tweet_area input[type='button']").prop("disabled", false);
